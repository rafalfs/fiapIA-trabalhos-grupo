...
Criamos um dataframe para fazer uma análise de clusterização com a distância em KM e o número de passageiros. Utilizamos o subset que contém somente as corridas cujo quadrante de origem ou destino seja um dos 15 pontos de interesse que selecionamos
...
E temos os clusters da distancia percorrida pelo número de passageiros.
Ele separou os clusters baseado principalmente nas distâncias das corridas.
Para corridas mais curtas existem dois clusters que são separados pelo número de passageiros.
Basicamente temos a seguinte segmentação:
1 - Corridas curtas com poucos pasageiros (até 2)
2 - Corridas curtas com muitos passageiros (3 ou mais)
3 - Corridas de média distância
4 - Corridas de longa distância
